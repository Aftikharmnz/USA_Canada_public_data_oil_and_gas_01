...
The current promoted USA run is `eia-20260728T164833Z`. It contains 217,223 canonical observations, 361 verified observed chart assets, and 361 checksum-linked forecast records (722 integrity entries). Canonical JSON is 89,851,624 bytes (85.69 MiB), below the 90 MiB publication guard. The merge inserted 4,711 observations, revised 0, and matched 8,951 unchanged rows. Forecast status is 353 ready, 1 `limited_history`, and 7 unavailable. Every one of the 66 weekly definitions reaches `2026-07-17`; monthly crude production and all 17 crude-movement routes reach `2026-04`. The total-products movement manifest conservatively reports `2026-03`: 16 route assets reach `2026-04`, while two end at `2026-03`. The previous last-known-good generation is `eia-20260722T202149Z`. GitHub Actions run `30379912166` completed successfully and deployed the matching public site.
