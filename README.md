...
**USA weekly breadth, USA PADD origin-destination movements, and the promoted Canada dashboard are deployed and verified.** The USA source registry has expanded to 78 active definitions—66 weekly and 12 monthly, classified as 21 **Crude** and 57 **Refined**—while its public page intentionally remains on the verified 69-definition last-known-good generation until the nine new monthly crude-balance definitions complete their first refresh and atomic promotion. The Canada source registry has likewise expanded to 81 active definitions while its public page remains on its verified 69-definition last-known-good generation. Registry activation means ingestion eligibility; the public manifest and integrity checks prove deployment. USA and Canada remain the two primary country pages, with `/reference/` as the educational glossary and `/products/` only a backwards-compatible USA-Refined entry.

The current promoted USA run is `eia-20260805T163902Z` and contains the previous 69-definition registry boundary. It contains 217,582 canonical observations, 361 verified observed chart assets, and 361 checksum-linked forecast records (722 integrity entries). Canonical JSON is 90,001,839 bytes (85.83 MiB), below the former single-file 90 MiB publication guard. The refresh inserted 74 observations, revised 60, and matched 12,673 unchanged rows. Forecast status is 353 ready, 1 `limited_history`, and 7 unavailable. Every one of the 66 weekly definitions reaches `2026-07-24`, and monthly crude production reaches `2026-05`. Fifteen of 17 crude-movement routes reach `2026-05`; routes 3→5 and 5→3 remain at `2026-04`, so the crude movement manifest conservatively reports `2026-04`. All 18 total-products routes reach `2026-05`. The previous last-known-good generation is `eia-20260729T175851Z`. GitHub Actions run `31026239390` completed successfully and deployed the matching public site.
...
The current promoted Canada last-known-good run is still `canada-20260803T170245Z` and predates that expansion. Its public manifest contains 69 definitions (67 Statistics Canada and 2 CER), presented as 31 **Crude** and 38 **Refined** choices. It contains 61,310 canonical observations, 467 verified observed chart assets with 467 matching forecast records (934 integrity entries), and 29,739,716 bytes (28.36 MiB) of canonical JSON; public assets occupy 12.78 MiB. The refresh inserted 35 rows, revised 0, and matched 56,335 unchanged rows. Statistics Canada balance tables 25-10-0063-01 and 25-10-0081-01 and movement table 25-10-0077-01 reach source month `2026-05`; CER reaches week `2026-07-21`. Forecast status is 360 ready, 74 `limited_history`, and 33 unavailable. The previous promoted generation is `canada-20260731T162758Z`; retention keeps the current and previous generations. Public manifest, asset, integrity, and Pages verification passed. A failed expanded refresh leaves this exact public generation in place.
...
The active USA registry divides 78 definitions into 21 **Crude** and 57 **Refined** choices. The currently promoted manifest still contains the preceding 69-definition boundary—12 Crude and 57 Refined—until the first complete monthly-balance refresh succeeds. The `/usa-weekly/` desk remains limited to the unchanged 66 weekly definitions.
