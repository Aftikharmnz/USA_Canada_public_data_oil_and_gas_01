...
class ProviderBoundaryTests(unittest.TestCase):
    ...
    def test_refresh_cli_dry_run_reads_registry_without_network_or_key(self) -> None:
        ...
        self.assertIn("usa.eia.crude.refinery_inputs.weekly", planned_ids)
        self.assertIn("usa.eia.crude.days_supply.weekly", planned_ids)
        self.assertIn("usa.eia.refined.propane.product_supplied.weekly", planned_ids)
