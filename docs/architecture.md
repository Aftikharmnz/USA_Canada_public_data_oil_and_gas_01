...
The current implementation covers EIA API v2, Statistics Canada full-table delivery, the CER weekly crude-runs file, strict registry/geography normalization, JSON generation storage, revision merging, observed analytics, standalone forecast assets, country manifests, unchanged-poll suppression, and scheduled same-workflow refresh/Pages deployment. Promoted USA run `eia-20260805T163902Z` contains all 69 active definitions (66 weekly and three monthly), including the 28 Phase 4 additions represented by 77 exact source-series keys and two monthly PADD-movement definitions: 217,582 canonical observations, 361 verified observed chart assets, 361 matching forecast records (722 integrity entries), and 90,001,839 bytes (85.83 MiB) of canonical JSON. Its refresh inserted 74 rows, revised 60, and matched 12,673 unchanged rows; forecast status is 353 ready, 1 `limited_history`, and 7 unavailable. All weekly definitions reach `2026-07-24`, and monthly crude production reaches `2026-05`. Fifteen of 17 crude routes reach `2026-05`; routes 3→5 and 5→3 remain at `2026-04`, so series freshness remains `2026-04`. All 18 total-products routes reach `2026-05`. The previous USA last-known-good generation is `eia-20260729T175851Z`, and public workflow run `31026239390` deployed the matching site. Promoted Canada run `canada-20260803T170245Z` contains all 69 active definitions (67 Statistics Canada and 2 CER), classified as 31 Crude and 38 Refined, with 61,310 canonical observations, 467 verified observed chart assets, 467 matching forecast records (934 integrity entries), and 29,739,716 bytes (28.36 MiB) of canonical JSON. Public assets occupy 12.78 MiB. The refresh inserted 35 rows, revised 0, and matched 56,335 unchanged rows; forecast status is 360 ready, 74 `limited_history`, and 33 unavailable. All three Statistics Canada tables reach `2026-05`, and CER reaches `2026-07-21`. The previous Canada last-known-good generation is `canada-20260731T162758Z`; retention keeps the current and previous generations. Each generated country manifest records its exact forecast readiness summary for that vintage. The verified public site is https://aftikharmnz.github.io/USA_Canada_public_data_oil_and_gas_01/; the replacement EIA secret is configured and the automated workflow has captured provider updates. Durable complete raw-body archival and release-time vintage reconstruction remain target architecture rather than current runtime claims.
